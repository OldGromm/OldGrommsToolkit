...
GRTK_InstanceData["PvP"] = { 30, 489, 529, 559, 562, 566, 572, 607, 617, 628, 726, 727, 761, 968, 980, 998, 1105, 1134, 1170, 1191, 1280, 1504, 1505, 1552, 1672, 1681, 1691, 1803, 1825, 1911, 2106, 2107, 2118, 2167, 2177, 2197, 2245, 2373, 2509, 2547, 2563, 2656, 2759, 2799 }
...
-- Retail
------ 2678 / The Timeways
GRTK_InstanceData["Timeways"] = { 2678 }
...
GRTK_InstanceData["Midnight_Season2"] = { 1762, 1877, 2521 }
...
------ 9609 / Temple of the Jade Serpent
------ 9619 / Stormstout Brewery
------ 9629 / Gate of the Setting Sun
------ 9949 / Mogu'shan Palace
------ 10119 / Siege of Niuzao Temple
...
------ 1126 / Kirin Tor Offensive (all of the quests, regardless of faction, have the same instance id)
------ 1130 / Blood in the Snow
------ 1131 / Secrets of Ragefire
------ 1135 / Troves of the Thunder King
------ 1144 / Dark Heart of Pandaria
------ 1148 / Proving Grounds

GRTK_InstanceData["Mists"] = { 959, 960, 961, 962, 994, 996, 999, 1000, 1005, 1008, 1009, 1011, 1024, 1030, 1031, 1048, 1050, 1051, 1095, 1098, 1099, 1102, 1103, 1104, 1112, 1126, 1130, 1131, 1135, 1136, 1144, 1148 }
...
GRTK_InstanceData["Wrath"] = { 533, 574, 575, 576, 578, 595, 599, 600, 601, 602, 603, 604, 608, 615, 616, 619, 624, 631, 632, 649, 650, 658, 668, 724 }
...
GRTK_InstanceData["BurningCrusade"] = { 269, 532, 534, 540, 542, 543, 544, 545, 546, 547, 548, 550, 552, 553, 554, 555, 556, 557, 558, 560, 564, 565, 568, 580, 585 }




-- Classic Era (aka Vanilla)
...
GRTK_InstanceData["Vanilla"] = { 33, 34, 36, 43, 47, 48, 70, 90, 109, 129, 189, 209, 229, 230, 249, 289, 309, 329, 349, 389, 409, 429, 469, 509, 531, 533 }